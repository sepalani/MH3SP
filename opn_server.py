...
class OpnServer(PatServer):
    ...
    def __init__(self, address, handler_class, binary_loader, max_thread_count=0,
                 logger=None, debug_mode=False, no_timeout=False,
                 ssl_cert=None, ssl_key=None):
        super(OpnServer, self).__init__(address, handler_class, binary_loader,
                max_thread_count, logger=logger, debug_mode=debug_mode, no_timeout=no_timeout)
